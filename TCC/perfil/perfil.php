...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <?php
        ...
        ?>
        <center>
        <form class="col s12" method="post" action="../user_action/deletar.php">
          <div class="login-page">
  <div class="form">
    <form class="register-form">
    <input type="hidden" name="id_user" value="<?php echo $dados['id_user']?> />
    <?php echo $loggedin_id ?>  
    <label for="nome">Nome</label>
    <input type="text" id="nome" name="nome" readonly  value="<?php echo $dados['nome']?>"/>   
    <label for="email">Email</label>           
      <input type="text" id="email" name="email" readonly value="<?php echo $dados['email']?>"/>
      <label for="senha">Senha</label>
      <input type="password" id="senha" name="senha" readonly value="<?php echo $dados['senha']?>"/>
      <label>
            ...
            <button style="background:#FF3030; margin-top:5px;" name="btn_deletar">apagar dados</button>
    </form>
  </div>
</div>
            <br />
